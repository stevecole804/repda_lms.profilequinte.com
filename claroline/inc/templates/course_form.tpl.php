    ...
    <fieldset  class="collapsible" id="mandatories">
        ...
        <div class="collapsible-wrapper">
            <dl>
                ...
                <dd>
                    <input type="text" id="course_officialCode" name="course_officialCode" value="<?php echo claro_htmlspecialchars($this->course->officialCode); ?>" maxlength="40" />
                    <?php if (empty($this->course->courseId)) : ?>
                    <br />
                    <span class="notice"><?php echo get_lang('max. 40 characters, e.g. <em>ROM2121</em>'); ?></span>
                    <?php endif; ?>
                </dd>
