        ...
        <div id="languageBox">
            ...
            <fieldset style="border: 0; margin: 10px 0 15px 0; padding: 5px;">
                ...
                <?php foreach ($this->languages as $key => $elmt) : ?>
                    <option value="<?php echo $_SERVER['PHP_SELF']; ?>?language=<?php echo $elmt; ?>"<?php if (!empty($this->currentLanguage) && $elmt == $this->currentLanguage) : ?> selected="selected"<?php endif; ?>>
                        <?php echo $key; ?>
                    </option>
                <?php endforeach; ?>
                </select>
    ...
    <table>
      <tr>
        ...
        <td class="userCourseList">
            ...
            <?php echo get_lang($this->templateMyCourses->render()); ?>
        </td>
      </tr>
    </table>
