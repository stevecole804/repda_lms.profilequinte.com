...
class ClaroCategory
{
    ...
    public function displayForm ($cancelUrl=null)
    {
        ...
        $html .= '<dt>'
            ...
            . '</label></dt>'
            . '<dd><input type="text" id="category_code" name="category_code" value="' . claro_htmlspecialchars($this->code) . '" size="40" maxlength="40" />'
            . (empty($this->id) ? '<br /><span class="notice">'.get_lang('max. 40 characters, e.g. <em>ROM2121</em>').'</span>':'')
            . '</dd>' . "\n" ;
